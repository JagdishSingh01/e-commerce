...
//customizable light text theme
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelSmall: TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Color.fromRGBO(0, 0, 0, 0.5)),
  );
...
//customizable dark text theme
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall: TextStyle().copyWith(fontSize: 12, fontWeight: FontWeight.normal, color: Color.fromRGBO(255, 255, 255, 0.5)),
  );
}
